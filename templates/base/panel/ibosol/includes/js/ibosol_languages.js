/**
 * IBO Solutions Languages JavaScript
 * 
 * Handles client-side functionality for the IBO Solutions language management including
...
var handleEditableFieldConstruct = function () {
    ...
    if (typeof editableIds !== 'undefined' && editableIds.length > 0) {
        editableIds.forEach(function (id) {
            $('#' + id).editable({
                url: './includes/post_ibosol_languages.php',
                type: 'text',
                pk: function () {
                    return $(this).data('pk');
                },
...
$(function () {
    ...
    $("#lang_select").on("change", function () {
        ...
        $.ajax({
            url: "./includes/get_ibosol_languages.php",
            type: "POST",
            data: {
