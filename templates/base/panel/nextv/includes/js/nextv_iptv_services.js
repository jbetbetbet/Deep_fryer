/**
 * NEXTV IPTV Services JavaScript
 * 
 * Handles client-side functionality for the NEXTV IPTV Services management including
...
$(function () {
    ...
    $("#post_service").on("submit", function (e) {
        ...
        $.ajax({
            type: "POST",
            url: "./includes/post_nextv_iptv_services.php",
            data: formData,
            processData: false,
            contentType: false,
            success: function () {
