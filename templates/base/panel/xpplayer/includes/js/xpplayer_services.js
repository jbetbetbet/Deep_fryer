/**
 * XP Player Services JavaScript
 * 
 * Handles client-side functionality for the XP Player Services management including
 * form submissions, AJAX requests, and UI interactions.
 * 
 * @package Cockpit
 * @subpackage XP Player
 */
...
$(function () {
    ...
    $("#post_service").on("submit", function (e) {
        ...
        $.ajax({
            type: "POST",
            url: "./includes/post_xpplayer_services.php",
            data: formData,
            processData: false,
            contentType: false,
            success: function () {
