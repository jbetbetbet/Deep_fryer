/**
 * QSmart IPTV Services JavaScript
 * 
 * Handles client-side functionality for the QSmart IPTV services management including
...
$(function () {
    ...
    $("#post_service").on("submit", function (e) {
        ...
        $.ajax({
            type: "POST",
            url: "./includes/post_qsmart_services.php",
            data: formData,
            processData: false,
            contentType: false,
            success: function () {
