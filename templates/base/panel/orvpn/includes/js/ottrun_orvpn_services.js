/**
 * ORVPN Services JavaScript
 * 
 * Handles client-side functionality for the ORVPN Services management including
...
$(function () {
    ...
    $("#post_service").on("submit", function (e) {
        ...
        $.ajax({
            type: "POST",
            url: "./includes/post_ottrun_orvpn_services.php",
            data: formData,
            processData: false,
            contentType: false,
            success: function () {
 ...
 * @param {string} expirey The expiry date of the client
 */
