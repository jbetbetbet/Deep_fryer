/**
 * 1-Stream Player Services JavaScript
 * 
 * Handles client-side functionality for the 1-Stream Player Services management including
...
$(function () {
    ...
    $("#post_service").on("submit", function (e) {
        ...
        $.ajax({
            type: "POST",
            url: "./includes/post_1stream_services.php",
            data: formData,
            processData: false,
            contentType: false,
            success: function () {
